...
- [ ] T016 [US2] Register start_laundry and advance_laundry tools in src/assistant.py — start_laundry with optional washer_minutes/dryer_minutes params, advance_laundry with no params, both wired to laundry.py functions; add cancel handling for "never mind" / "didn't do laundry" in system prompt
